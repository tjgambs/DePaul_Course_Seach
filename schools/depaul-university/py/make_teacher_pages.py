...
def create_teacher_webpage(id,name,values):
	...
	<div id="help">
	    <div id="help-container">
			...
			5) Pressing "+" in the leftmost column will place that selected course into a specialized course cart located in the top right.<br />
			6) After adding courses you want to your course cart, you can create a mock schedule. Press "Generate Mock Schedule" and you will automatically be scrolled to the mock schedule. If you want to remove a course simply press "-" in the table and re-click "Generate Mock Schedule" for your new schedule. You can also view the required books by pressing "Buy Required Books." If you click on a book cover or book title, a new tab will open with that book ready for purchase on Amazon. <br /><br />
