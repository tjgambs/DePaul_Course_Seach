...
def create_page(full_name,description,course_url):
	...
	html +='''$.ajax({
	    ...
	    success: function(response)
	    {
	    	...
	    	headers = ['Add/Remove','Overall Rating','Class Status','Credit Hours', 'Teacher First Name', 'Teacher Last Name', 'Class Start Time', 'Class End Time', 'Class Section', 'Class Number', 'Location', 'Days'];
