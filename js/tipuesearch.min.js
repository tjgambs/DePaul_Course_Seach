(function($){$.fn.tipuesearch=function(options){var set=$.extend({'show':7,'newWindow':false,'showURL':false,'showTitleCount':true,'minimumLength':1,'descriptiveWords':60,'highlightTerms':false,'highlightEveryTerm':false,'mode':'static','liveDescription':'*','liveContent':'*','contentLocation':'tipuesearch/tipuesearch_content.json','debug':false},options);return this.each(function(){var tipuesearch_in={pages:[]};$.ajaxSetup({async:false});var tipuesearch_t_c=0;if(set.mode=='live')
...
{var m_c=tipuesearch_in.pages[i].text.match(pat).length;score+=(0*m_c);}
